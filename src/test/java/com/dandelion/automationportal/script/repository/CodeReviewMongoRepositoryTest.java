...
class CodeReviewMongoRepositoryTest extends BaseMongoRepositoryTest {
    ...
    void findAllTopicsByKeyTest() {
        ...
        WHEN();
        List<CodeReviewItem> actual = codeReviewMongoRepository.findAllTopicsByTopicKey(expectedKey);
